...
Датум објаве: 03.09.2026.

### Резултати практичног дела - Септембар1 

Резултате практичног дела испита у року Септембар1 можете погледати на следећем линку: [Резултати](https://docs.google.com/spreadsheets/d/1hXfwle8UZnMlCEPiPwxfI_Wv8kSTHC7Z64IfLkexQuw/edit?usp=sharing)

За увид у рад обратити се мејлом асистенту код ког сте распоређени.

-------

Датум објаве: 18.07.2026.

### Резултати практичног дела - Јун2 

Резултате практичног дела испита у року Јун2 можете погледати на следећем линку: [Резултати](https://docs.google.com/spreadsheets/d/1hXfwle8UZnMlCEPiPwxfI_Wv8kSTHC7Z64IfLkexQuw/edit?usp=sharing)

За увид у рад обратити се мејлом асистенту код ког сте распоређени најкасније у среду 22.7.

-------

Датум објаве: 03.07.2026.

### Резултати практичног дела - Јун1 

Резултате практичног дела испита у року Јун1 можете погледати на следећем линку: [Резултати](https://docs.google.com/spreadsheets/d/1hXfwle8UZnMlCEPiPwxfI_Wv8kSTHC7Z64IfLkexQuw/edit?usp=sharing)

За увид у рад обратити се мејлом асистенту код ког сте распоређени.

-------

Датум објаве: 22.6.2026.

### Бодови остварени на колоквијуму 

Студентима који су полагали колоквијум се остварени резултат признаје као замена за прва два задатка на испиту, у било ком испитном року. То значи да на испиту могу да раде само 3. и 4. задатак, док се бодови са колоквијума аутоматски урачунавају уместо бодова са прва два задатка.

Студенти који нису задовољни оствареним резултатом на колоквијуму могу да пониште бодове са колоквијума и полажу цео испит, сва 4 задатка. Захтев за поништавање потребно је послати предметном асистенту путем мејла најкасније пре изласка на испит.

Није могуће парцијално признавање бодова са колоквијума. Другим речима, није могуће задржати бодове остварене на једном задатку, а поново радити други задатак на испиту. Бодови са колоквијума се или у целости признају као замена за прва два испитна задатка или се у целости поништавају, након чега студент полаже комплетан испит. Једном поништен резултат на колоквијуму се не може важити у наредним роковима.

-------

Датум објаве: 29.5.2026.
...
Датум објаве: 20.5.2026.

### Пријава за колоквијум

Моле се студенти који планирају да изађу на колоквијум да попуне анкету најкасније до суботе 23.5. у подне.
[Линк ка анкети](https://docs.google.com/forms/d/e/1FAIpQLSfdtZWXAKNAXKaD6TzR14ok2kbICg5sjtYA53S0RCn2rpQp6Q/viewform?usp=dialog)

-------


Датум објаве: 3.4.2026.

### Организација колоквијума

Термин колоквијума у школској 2025/26. години је **недеља 24. мај 2026. године**, са почетком у 17.00 часова. На колоквијуму ће се проверавати знање из градива предвиђеног за вежбе, **закључно са осмом недељом наставе**, у складу са планом истакнутим на страници курса.

Kолоквијум замењује израду прва два задатка на испиту и није обавезан, а студенти који не приступе колоквијуму имаће могућност да на испиту полажу комплетно предвиђено градиво.

-------

Датум објаве: 8.3.2026.

### Резултати испита у року јануар ПС

Резултате испита у року јануар 2 ПС року можете наћи у наредној табели

[Резултати](https://docs.google.com/spreadsheets/d/1BqujF8LEiyJYspNoHsxI9j_vpg_LGk82-Ao-bMj0K6s/edit?usp=sharing) (таб јануар 2 ПС)

**Напомена:** Додатни поени се рачунају тек када се оствари праг на испиту.

За увид у радове се јавити мејлом на lucija.milicic@matf.bg.ac.rs 

-------

Датум објаве: 5.3.2026.

### Испит у року Јануар 2 ПС

Практични испит у року Јануар 2 ПС биће одржан у просторијама зграде у **Улици Светог Николе (Н сале)** 6.3.2026. са почетком у 17 часова.

-------

Датум објаве: 15.2.2026.

### Резултати испита у року јануар ПС

Резултате испита у року јануар ПС року можете наћи у наредној табели

[Резултати](https://docs.google.com/spreadsheets/d/1BqujF8LEiyJYspNoHsxI9j_vpg_LGk82-Ao-bMj0K6s/edit?usp=sharing) (таб јануар ПС)
...
Датум објаве: 29.12.2025.

### Резултати испита у децембарском року

Резултате испита у децембарском року можете наћи у наредној табели

[Резултати](https://docs.google.com/spreadsheets/d/1BqujF8LEiyJYspNoHsxI9j_vpg_LGk82-Ao-bMj0K6s/edit?usp=sharing) (таб децембар)
...
Датум објаве: 06.11.2025.

### Резултати испита у додатном року

Резултате испита у додатном року можете наћи у наредној табели

[Резултати](https://docs.google.com/spreadsheets/d/1BqujF8LEiyJYspNoHsxI9j_vpg_LGk82-Ao-bMj0K6s/edit?usp=sharing) (таб додатни рок)

**Напомена:** Додатни поени се рачунају тек када се оствари праг на испиту.

За увид у радове се можете јавити мејлом асистенту код ког сте распоређени.

-------

Датум објаве: 30.10.2025.

### Резултати септембар 2

Резултате испита у року септембар 2 можете наћи у наредној табели

[Резултати](https://docs.google.com/spreadsheets/d/1BqujF8LEiyJYspNoHsxI9j_vpg_LGk82-Ao-bMj0K6s/edit?usp=sharing) (таб сеп2)

**Напомена:** Додатни поени се рачунају тек када се оствари праг на испиту.

За увид у радове се можете јавити мејлом асистенту код ког сте распоређени до понедељка 3.11.

-------
Датум објаве: 27.10.2025.

### Организација испита у року септембар 2

Испит у року септембар 2 биће одржан само у просторијама на Студентском тргу, у складу са бројем студената пријављених путем анкете.
Моле се студенти да дођу мало пре почетка испита.


-------

Датум објаве: 25.10.2025.

### Пријава испита септембар 2

Молимо студенте који планирају да полажу испит у року септембар 2 да попуне наредну анкету до 27.10. у 20 часова.

[Анкета](https://forms.gle/nfVkx2dMqCuPCxZp8)

Молимо Вас да савесно попуните анкету.

-------

Датум објаве: 19.10.2025.

### Резултати септембар 1

Резултате испита у року септембар 1 можете наћи у наредној табели

[Резултати](https://docs.google.com/spreadsheets/d/1BqujF8LEiyJYspNoHsxI9j_vpg_LGk82-Ao-bMj0K6s/edit?usp=sharing) (таб сеп1)

**Напомена:** Додатни поени се рачунају тек када се оствари праг на испиту.

За увид у радове се можете јавити мејлом асистенту код ког сте распоређени до среде 22.10.
...
Резултате испита у јуну 2 можете наћи у наредној табели
...
Резултате испита у јуну 1 можете наћи у наредној табели
...
Резултате испита у јануару 2 можете наћи у наредној табели
...
Резултате испита у јануару 1 можете наћи у наредној табели
