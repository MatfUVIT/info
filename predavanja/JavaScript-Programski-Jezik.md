...
У примарне изразе спадају претходно описани литерали и константе, као и [променљиве](#променљиве){:target="_blank"}, које ће детаљније бити описане касније.
...
- `async function* //асинхрони функционални израз`

- `await //паузира/наставља/чека завршетак за асинхрону функцију`
...
Пример (рад са логичким вредностима):
...
Ови изрази представљају одредиште наредбе доделе. То могу бити:

- Променљиве

- Елементи за постављање особина
