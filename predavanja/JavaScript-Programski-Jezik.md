...
- **Динамички типизиран**: Код динамички типитзираних језика, променљива не утиче на тип. Програмер може доделити променљивој вредност ма ког типа, нпр. променљивој која је претходно садржавала целобројну вредност се може доделити ниска знакова (string) и сл.
...
**Напомена.** ЈаваСкрипт је програмски језик који се извршава у једној нити и он сам не може да извршава више истовремених паралелних радњи. Ипак, овако организовано окружење за извршавање омогућава више паралелних радњи (тзв. асихроно извршавање) - о томе че бити речи касније.
...
У овој секцији је дат опис цинтаксно коректних структура језика ЈаваСкрипт.
