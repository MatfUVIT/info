...
- Предефинисани и изведени прости типови

- Сложени типови, елементи `sequence`, `all` и `choice`

- Прости типови, уније и листе

- Сложени типови, елементи `group` и `attributeGroup`

- Kључеви и референце (страни кључеви)

- Препоруке за дефинисање схема [веб страна](tekstovi/Jezici-za-obelezavanje-XML-XSD){:target="_blank"}
