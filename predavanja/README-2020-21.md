...
5.2.3. SGML и дефиниције типа документа (DTD) [веб страна](tekstovi/SGML-Definicja-tipa-dokumenta){:target="_blank"} [филм](https://www.youtube.com/watch?v=lmuz-IiZGiY&feature=youtu.be&t=0m3s){:target="_blank"}

- Унутрашњи и спољашњи DTD

- Елементи  [филм](https://www.youtube.com/watch?v=lmuz-IiZGiY&feature=youtu.be&t=11m49s){:target="_blank"}

- Ентитети  [филм](https://www.youtube.com/watch?v=lmuz-IiZGiY&feature=youtu.be&t=13m58s){:target="_blank"}

- Коментари, означене секције и инструкције процесиранја  [филм](https://www.youtube.com/watch?v=lmuz-IiZGiY&feature=youtu.be&t=19m5s){:target="_blank"}

- Атрибути код SGML и DTD  [филм](https://www.youtube.com/watch?v=r8Il8a-xx5Q&feature=youtu.be&t=0m3s){:target="_blank"}
...
- Простори имена код XML

- Структурисање података код XML

- Добро формирани и валидни XML

5.3.3. XML и DTD

5.3.4. XML и XML схеме

- Принципи дизајна за XML схеме

5.3.5. Структура XML схема

- Пролог XML схеме

- Глобални елементи и типови

- Локални елементи и тпови

- Елементи и атрибути

- Анонимни типови

- Предефинисани прости типови

- Изведени прости типови

- Прости типо листи

- Прости тип уније

- Сложени тип, елеменат `sequence`

- Сложени тип, елеменат `choice`

- Сложени тип, елеменат `group`

- Сложени тип, елеменат `attributeGroup`

- Дефиниција кључева

- Референце (страни кључеви)

5.3.6. XML и програмерске парадигме

- XML и објектно орјентисано програмирање

- XML и релационе базе података

- XML и NoSQL базе података

- Програмерски модели процесирања XML-а

- Упити над XML-ом (XPath и XQuery)
