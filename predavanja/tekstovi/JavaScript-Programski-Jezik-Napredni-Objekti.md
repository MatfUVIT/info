...
Када ЈаваСкрипт окружење за извршавање тражи неку особину/методу, прво се проверава да ли је она дефинисана у оквиру тог објекта, а потом да ли је дефинисана  дефинисали у оквиру свог прототипског објеката. Уколико особина/метод није пронађен ту, онда га тражи у родитељском прототипском објекту. Уколико ни тамо не нађе та особина/метод, тражиће се даље дуж ланца међусобно повезаних прототyпској објеката, све док не дође до последњег у ланцу `Object.prototype`. Ако га не нађе ни у овом прототипу ЈаваСкрипт окружење за извршавање врати `undefined` вредност.
...
**Пример.** Илуструје, на примеру објеката који представљају тачке, како имитирати приватне поља. Овде се у ту сврху користе затворења и методи за читање и постављање особина.
