...
Када ЈаваСкрипт окружење за извршавање тражи неку методу, прво се проверава да ли је она дефинисана у оквиру тог објекта, а потом да ли је дефинисана  дефинисали у оквиру свог прототипског објеката. Уколико метод није нађен ту, онда га тражи у родитељском прототипском објекту. Уколико ни тамо не нађе тај метод, тражиће даље дуж ланца међусобно повезаних прототyпској објеката, све док не дође до последњег у ланцу `Object.prototype`. Ако га не нађе ни у овом прототипу ЈаваСкрипт окружење за извршавање избацује грешку.
