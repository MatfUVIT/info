...
| :------: | :------- | :--- | :----- |
| &lt;!ELEMENT ime_elementa (potomak1+)&gt; | Указује да се елеменат - потомак може појавити један или више пута унутар родитељског елемента. | &lt;!ELEMENT adresa (ime+)&gt; |

<table class="table table-bordered">
<tbody><tr>
<th style="text-align:center;">Оператор</th>
<th style="text-align:center;" width="25%">Синтакса</th>
<th style="text-align:center;" width="25%">Опис</th>
<th style="text-align:center;">Пример</th>
</tr>
<tr>
<td class="ts">+</td>
<td class="ts">&lt;!ELEMENT ime_elementa (potomak1+)&gt;</td>
<td class="ts">Указује да се елеменат - потомак може појавити један или више пута унутар родитељског елемента.</td>
<td><p>&lt;!ELEMENT adresa (ime+)&gt;</p>
<p>Елеменат - потомак <i>ime</i> може да се појави једном или више пута унутар родитељског елемента <i>adresa</i>.</p>
</td>
</tr>
<tr>
<td class="ts">*</td>
...
<td><p>&lt;!ELEMENT adresa (ime*)&gt;</p>
<p>Елеменат - потомак <i>ime</i> може да се појави нула, једном или више пута унутар родитељског елемента <i>adresa</i>.</p>
</td>
</tr>
<tr>
<td class="ts">?</td>
...
<td><p>&lt;!ELEMENT adresa (ime?)&gt;</p>
<p>Елеменат - потомак <i>ime</i> може да се појави нула или један пут унутар родитељског елемента <i>adresa</i>.</p>
</td>
</tr>
<tr>
<td class="ts">,</td>
<td class="ts">&lt;!ELEMENT ime_elementa (potomak1, child2)&gt;</td>
<td class="ts">Даје секвенцу елемената-потомака одвојених зарезом који морају бити укључени у родитељски елеменат.</td>
<td><p>&lt;!ELEMENT adresa (ime, kompanija)&gt;</p>
<p>Секвенца елемената - потомака <i>ime</i>, <i>kompanija</i>, који се морају појавити у истом редоследу унутар елемента <i>adresa</i>.</p>
</td>
</tr>
<tr>
<td class="ts">|</td>
...
<td><p>&lt;!ELEMENT adresa (ime | kompanija)&gt;</p>
<p>Омогућава доношење избора који ће од елементата-потомкака тј. <i>ime</i> или <i>kompanija</i>, морати да се појави унутар елемента <i>adresa</i>.</p>
</td>
</tr>
</tbody></table>
...
У овом примеру је коришћена и кључна реч `#FIXED` где означава да је вредност `"matf"` једина вредност за име атрибута елемента `<kompanija>`. Ако покушамо да променимо вредност атрибута, то даје грешку. 
