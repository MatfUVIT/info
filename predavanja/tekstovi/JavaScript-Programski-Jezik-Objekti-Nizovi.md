...
ЈаваСкрипт је језик базиран на објектима. Са изузетком конструкција као што су циклуси и оператори, скоро све ЈаваСцрипт могућности су, у већој или мањој мери, имплементиране коришћењем објеката.
...
2. Објекти уграђени у ЈаваСцрипт. Ту спадају објекти који омотавају приемитвне типове података (`String`, `Number`, `Boolean`), објекти који омогућавају креирање кориснички дефинисаних објеката и сложених типова (`Object`, `Array`) и објекти који поједностављују уобичајене задатке, као што су `Date`, `Math`.
...
Поједини елементи друге групе објеката из форње поделе су већ описани у ранијим поглављима. Ово поглавље је посвећено основном раду са објектима и низовима, док ће напреднији рад бити описан нешто касније.
...
Објекат се најлакше прави помоћу објектног литерала. Објектни итерал  састоји се од спсиска парова својство-вредност, где је  двотачка (тј знак `:`) постављен између својства и вредности. Парови својство-вредност у спсику се међусобно раздвајају зарезима (знаком `,`), а списак се наводи унутар витичастих заграда (пара знакова `{` и `}`).
...
Низ је уређен скуп вредности. Те вредности се називају елементи низа. Сваки елемент низа има своју нумерички описану позицију - индекс.
