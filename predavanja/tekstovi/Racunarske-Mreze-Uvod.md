...
- Комуникација: електронска пошта, друштвене мреже, Скајп (енгл. Skype), Вибер (енгл. Viber),...
...
- Мрежа равноправних рачунара (енгл. peer-to-peer, P2P): BitTorrent
...
Обично је то мрежна картица (мрежни адаптер или ЛАН картица – енгл. network interface controller, NIC), која се уграђује у рачунар и
...
2. Друга важна мера квалитета је **кашњење** (енгл. latency) - време
