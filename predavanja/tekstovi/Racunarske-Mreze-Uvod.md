...
![Пример рачунарске мреже](assets/images/network-example02.jpg "Пример рачунарске мреже"){:float="center"}
...
![Клијент-сервер и мрежа равноправних рачуара](assets/images/klijent-server-peer-to-peer.png "Клијент-сервер и мрежа равноправних рачуара"){:float="right"}
