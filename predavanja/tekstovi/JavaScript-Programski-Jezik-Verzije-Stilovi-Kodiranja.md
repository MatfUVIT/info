...
![Извршавање у node.js окружењу](assets/images/node-js-exec-01.png "Извршавање у node.js окружењу"){: style="float:center; padding:16px"}

#### Дебагирање у окружењу node.js коришћењем VS Code

Развојно окружење VS Code се може користити за дебагирање ЈаваСкрипт програма. Ово окружење подржава постављање тачака лома (енгл. brakpoint) на којима се зауставља извршавање, одакле се оно може наставити корак по корак или непрекидно до краја, односно следеће постављене тачке лома. Када је извршавање програма заустављено, окружење допушта да се прочитају вредности променљивих, проучи стек позива и све елементе на њему итд. - то су мање-више могућности које имају и друга модрена развојна окружења.

![Дeбагирање помоћу VS Code](assets/images/vs-code-debuging-01.png "Дeбагирање помоћу VS Code"){: style="float:center; padding:16px"}
...
![Извршавање у веб прегледачу](assets/images/web-browser-exec-01.png "Извршавање у веб прегледачу"){: style="float:center; padding:16px"}
...
![Дебагирање у веб прегледачу](assets/images/web-browser-debuging-01.png "Дебагирање у веб прегледачу"){: style="float:center; padding:16px"}
