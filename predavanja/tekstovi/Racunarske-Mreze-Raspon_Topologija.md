...
- Дељење таласне дужине (wave division multiplexing - WDM)
...
[Пример мреже са заједничким комуникационим каналом](ааа)
...
[Примери мрежа са топологијом магистрале, звезде и прстена](ааа)
...
[Пример мреже са директним везама чвор-чвор](ааа)

- Комутирање (switching) - одређживање путање пре или током саме
комуникације

[Пример комутирања при комуникацији чвор-чвор](ааа)
