...
![Магистрала](assets/images/bus-network-example.png "Магистрала"){: height="250px" style="float:right; padding:16px"}
...
![Звезда](assets/images/star-network-example.png "Звезда"){: height="250px" style="float:right; padding:16px"}
...
![Прстен](assets/images/ring-network-example.png "Прстен"){: height="250px" style="float:right; padding:16px"}
...
![Пример мреже са директним везама чвор-чвор](assets/images/peer-to-peer-network-example.png "[Пример мреже са директним везама чвор-чвор"){: style="float:center; padding:16px"}

- Комутирање (switching) - одређживање путање пре или током саме
комуникације

![Пример комутирања при комуникацији чвор-чвор](assets/images/network-routing-example.png "[Пример комутирања при комуникацији чвор-чвор"){: style="float:center; padding:16px"}
