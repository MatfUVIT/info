...
Овде се смешта део кода који је спреман да се пошаље на извршавање ЈаваСкрипт машини. Ова меморија се заузима и ослобађа на начин карактеристичан за редове (FIFO). Део кода који се шаље на извршавање ЈаваСкрипт машини се из Реда повратних позива пребацује на Стек. Одлуку о томе када ће се извршити пребацивање кода из Реда повратних позива на Стек доноси компонента Петља за догађаје. С обзиром да Ред повратних позива садржи задатке које треба извршити ЈаваСкрипт окружење, понегде у литератури се овај ред још назива и ред задатака (Task Queue).
