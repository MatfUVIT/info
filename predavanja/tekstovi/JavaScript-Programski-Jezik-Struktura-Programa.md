...
```js
let x = 5 & 1; // 5&1=(1010)&(0001)=(0001) pa je razultat 1
...
Шаблони за ниске, уведени у верзији ЈаваСкрипта ES6 (или ES2015), су ниска-литерали који допуштају моћнији начин за дефинисање ниски.
