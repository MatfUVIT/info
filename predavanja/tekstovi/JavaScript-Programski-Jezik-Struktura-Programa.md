...
у логичким изразима могу учествати оператори који враћају логичку вредност. Такви операори су нпр. оператори поређења, који упоређују вредности два израза, тј. вредност израза лево од оператора поређења пореде са вредношћу израза десно од оператора поређења.
