...
**Пример.** Скрипта са бесконачним `for` циклусом са искакањем (без обележја), којом се понавља извлачење псеудослучајних бројева док извучени број не буде између `0` и `0.1`, а потом прикаѕује извучени број, као ито из ког је покушаја тај број извучен:
