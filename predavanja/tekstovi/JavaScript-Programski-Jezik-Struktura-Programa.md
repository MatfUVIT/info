...
- Локални опсег дефинисаности - све до верзије ES6 у ЈаваСкрипта, локалну опсег је било могуће направити искључиво коришћењем функције (што је сматрано једном од највећих мана самог језика). Новом ревизијом језика “ES6” је омогућено дефинисање локалног тзв. блоковског опсега дефинисаности уз помоћ резервисане речи `let`.
...
- `toPrecision(x)` - [форматира](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number/toPrecision){:target="_blank"} број на прецизност `x`
