...
Async/await синтакса не искључује обећања, него мења начин конзумирања обећања. Ова синтакса омогућава програмеру да пише асинхрони код према секвенцијалном редоследу извршавања тако да личи на синхрони код.

#### Асинхроно програмирање и наредбa yield
