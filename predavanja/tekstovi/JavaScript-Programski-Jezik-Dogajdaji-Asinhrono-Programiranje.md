...
## Асинхроно програмирање и догађаји  
...
6. Петља за догађаје потом, када стек постане празан, а овај задатак "дође на ред" пребацује таск (цаллбацк функцију) из таск qуеуе само ако је празан стацк.

Када се цаллбацк функција надје на стацк-у извршава се и након тога склања са стацк-а
